...
- иногда вылетает при удалении/создани гуи окон
...
- на клиенты белка не понимает число 500, вылетает
...
- при перезапуске ресурсов в консоле сервера, скрипты ломаются
