...
local text_3d = [//--3d text
	...
	[374.967,117.759,-21.0186, 5.0, "Погрузка филе рыбы (Загрузить филе рыбы - E)"],//--погрузка рыбы с рз
	...
	[-299.495,-734.244,-21.422, 15.0, "Разгрузка филе рыбы (Разгрузить рыбу - E)"],//порт
	[365.745,116.044,-21.2489, 5.0, "Разгрузка живой рыбы (Разгрузить рыбу - E)"],//--рыбзавод
